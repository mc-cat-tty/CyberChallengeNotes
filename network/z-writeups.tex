...
\section{NS_0.07 - Level7 - NAT2}
On node 3: \texttt{ip addr add 172.16.44.200/24 dev eth0}
On node 2: \texttt{ip addr add 172.16.44.100/24 dev eth1}
On node 1: \texttt{ip route add 172.16.44.0/24 via 10.0.0.2; iptables -t nat -A POSTROUTING --source 192.168.123.0/24 -o eth1 -j MASQUERADE}
On host: \texttt{ssh root@172.16.44.200}
