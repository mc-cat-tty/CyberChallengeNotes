...
\texttt{gdb --batch --command=scripts/volatility.gdb volatility}
...
\texttt{gdb --batch -x scripts/nextgen_safe.gdb nextgen_safe}

\subsection{SS_1.02 - Slow Printer}
\texttt{gdb --batch -x slow_printer.gdb slow_printer}
